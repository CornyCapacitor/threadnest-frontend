          ...
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              <form onSubmit={handleChangeUsername} className="flex flex-col gap-2 py-1 ml-2 max-w-[90%]">
                ...
                <label htmlFor="new-username" className="flex text-slate-200 font-semibold">
                  Repeat new username
                </label>
                <Input id="new-username" type="text" value={newUsernameRepeat} onChange={(e) => setNewUsernameRepeat(e.target.value)} />
